...
class ExtendedRadiationModelTests(unittest.TestCase):
    ...
    def testCorrectnessNormalize(self):
        ...
        p1 = MigrationModels.extendedRadiationModel(features, features, s, 1.5, normalize=True)
        p2 = MigrationModels.extendedRadiationModel(features, features, s, 1.5, normalize=True, slowMode=True)
    ...
    def testCorrectnessNoNormalize(self):
        ...
        p1 = MigrationModels.extendedRadiationModel(features, features, s, 1.5, normalize=False)
        p2 = MigrationModels.extendedRadiationModel(features, features, s, 1.5, normalize=False, slowMode=True)
