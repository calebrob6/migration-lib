...
'''
Usage: python calculateCommonCounties.copyright

This script calculates which FIPS are shared between all of the years of migration data.

Outputs output/largestCountyIntersection_2004_2014.txt which is a numerically sorted list of FIPS codes in the continental USA that are common across all years of data.
'''
...
def main():
    ...
    f = open("output/largestCountyIntersection_2004_2014.txt", "w")
